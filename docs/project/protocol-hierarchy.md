...
- `syncSortDescriptor(for:)` — translates a keypath to a SwiftData `SortDescriptor` (default: `nil`)
- `syncSortDescriptors(for:)` — maps a list of keypaths to sort descriptors
