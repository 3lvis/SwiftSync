...
@attached(extension, conformances: SyncUpdatableModel, ExportModel, SyncQuerySortableModel, names: named(SyncID), named(syncIdentity), named(syncIdentityRemoteKeys), named(syncDefaultRefreshModelTypes), named(syncRelatedModelType), named(syncSortDescriptor), named(make), named(apply), named(syncApplyGeneratedRelationships), named(exportObject))
